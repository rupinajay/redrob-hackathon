...
| HP-3 | Current role > 12 years at startup/AI/tech company | ✅ | Catches 0 in this dataset |
...
| F: Behavioral | **× [0.40, 1.20]** | **× [0.40, 1.20]** | 11 PRP signals | ✅ |
...
**Note on behavioral discrimination:** With floor=0.40 and cap=1.20, the max positive sum is ~+0.57 and max negative sum is ~−0.78. The range provides meaningful differentiation — candidates with strong behavioral signals get up to 1.20, while poor signals can drop to 0.40. This is wider than prior versions and matches PRP spec.
